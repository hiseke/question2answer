...
return array(
    ...
    'flagged_body' => "Ein Beitrag von ^p_handle hat ^flags:\n\n^open^p_context^close erhalten\n\nKlicke auf den folgenden Link, um den Beitrag zu sehen:\n^url\n\nKlicke auf den folgenden Link, um alle ausstehenden, markierten Beiträge zu prüfen:\n\n^a_url\n\nVielen Dank,\n\n^site_title",
    'flagged_subject' => "^site_title hat einen Beirag markiert",
    'private_message_body' => "Du hast eine private Nachricht von ^f_handle auf ^site_title:\n\n^open^message^close erhalten.\n\n^moreVielen Dank,\n\n^site_title\n\n\nUm private Nachrichten zu sperren, logge dich bitte in deinen Account ein:\n^a_url",
    ...
    'to_handle_prefix' => "^,\n\n",
    'remoderate_body' => "Ein bearbeiteter Beitrag von ^p_handle benötigt deine Bestätigung:\n\n^open^p_context^close\n\nKlicke unten, um den Beitrag zu bestätigen oder auszublenden:\n\n^url\n\n\nKlicke unten, um alle Beiträge in der Warteschlange zu bestätigen:\n\n^a_url\n\n\nDanke,\n\n^site_title",
    ...
    'wall_post_subject' => "Beitrag auf deiner ^site_title Pinnwand",
    'wall_post_body' => "^f_handle hat an deine Pinnwand geschrieben auf ^site_title:\n\n^open^post^close\n\nDu kannst auf den Beitrag hier antworten:\n\n^url\n\nDanke,\n\n^site_title",
);
