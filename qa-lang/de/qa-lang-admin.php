...
return array(
    ...
    'after_main_menu' => 'Nach den Tabs im Kopfbereich',
    'after_x' => 'Nach "^"',
    ...
    'blobs_move_moved' => 'Migration ^1 von ^2 hochgeladenen Bildern und Dokumenten',
    ...
    'block_ips_note' => 'Verwende einen Bindestrich für Bereiche oder * für eine beliebige Anzahl Übereinstimmungen. Beispiele: 192.168.0.4, 192.168.0.0-192.168.0.31 192.168.0.*',
    ...
    'caching_cleanup' => 'Caching Aufräumarbeiten',
    'caching_delete_all' => 'Lösche kompletten Cache',
    'caching_delete_complete' => 'Cache erfolgreich gelöscht',
    'caching_delete_expired' => 'Lösche Cache nach Verfallsdatum',
    'caching_delete_progress' => '^1 von ^2 Cache-Dateien gelöscht...',
    'caching_dir_error' => 'Das als QA_CACHE_DIRECTORY definierte Verzeichnis ^ ist nicht überschreibbar durch den Webserver.',
    'caching_dir_missing' => 'Cache-Verzeichnis wurde nicht definiert.',
    'caching_dir_public' => 'Das als QA_CACHE_DIRECTORY definierte Verzeichnis ^ muss außerhalb des Hauptverzeichnisses der Webseite liegen.',
    'caching_num_items' => 'Anzahl der Einträge im Cache',
    ...
    'categories_not_shown' => 'Manche Fragen haben Kategorien, die nicht angezeigt werden.',
    ...
    'database_cleanup' => 'Datenbank Bereinigungsoperationen',
    ...
    'delete_widget_position' => 'Lösche diese Erweiterung der Position',
    ...
    'form_security_expired' => 'Sicherheits Code abgelaufen - versuche es erneut',
    'from_anon' => 'Von Unbekannt:',
    'from_users' => 'Von Benutzer:',
    'general_title' => 'Haupttitel',
    'hidden_answers_deleted' => 'Lösche ^1 von ^2 versteckten Antworten ohne Abhängigkeiten...',
    'hidden_comments_deleted' => 'Versteckter Kommentar ^1 von ^2 gelöscht...',
    'hidden_questions_deleted' => 'Lösche ^1 von ^2 versteckten Fragen ohne Abhängigkeiten...',
    ...
    'mailing_unsubscribe' => 'Ein Abmelde-Link wird in jeder Nachricht im Fußbereich hinzugefügt.',
    ...
    'no_memcached' => 'Die Memcached PHP Erweiterung ist nicht installiert.',
    ...
    'recalc_hotness_q_view_note' => 'Kann die Seitenladezeit leicht erhöhen, wenn deaktiviert. Aber Beliebtheitswerte werden veraltet sein, wenn Aufrufe in den Beliebtheitseinstellungen berücksichtigt werden.',
